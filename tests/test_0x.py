...
def test__fillLimitOrder_swap():
    ...
    swap = Swap(
        ...
        block_number=block_number,
        trace_address=[0, 1, 0],
        contract_address="0x1fcc3e6f76f7a96cd2b9d09f1d3c041ca1403c57",
        from_address="0xdef1c0ded9bec7f1a1670819833240f027b25eff",
        to_address="0x1fcc3e6f76f7a96cd2b9d09f1d3c041ca1403c57",
